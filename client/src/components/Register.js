  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-dark text-light">
      <form onSubmit={handleSubmit} className="bg-dark-accent p-8 rounded shadow-md w-80">
        ...
        <button type="submit" className="w-full bg-accent-blue text-white font-bold py-2 rounded hover:bg-blue-700">Register</button>
      </form>
      <p className="mt-4 text-sm text-center">
        Already have an account? <a href="/login" className="text-accent-blue underline">Login</a>
      </p>
    </div>
  );
};
